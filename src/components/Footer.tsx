          ...
          <div className="flex flex-col gap-5 sm:col-span-2 md:col-span-1">
            ...
            <div>
              <p className="text-[10px] font-semibold text-charcoal uppercase tracking-widest mb-3 font-sans">
                GỌI MUA HÀNG{' '}
                <span className="font-normal text-luxury-muted">(Phím 1) (8:00 - 22:00)</span>
              </p>
            ...
            <div>
              <p className="text-[10px] font-semibold text-charcoal uppercase tracking-widest mb-3 font-sans">
                GÓP Ý, KHIẾU NẠI{' '}
                <span className="font-normal text-luxury-muted">(Phím 3) (8:00 - 21:00)</span>
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-luxury-warm border border-luxury-border flex items-center justify-center flex-shrink-0">
                  <svg
          ...
          <div>
            ...
            <div className="text-xs text-charcoal-light space-y-1.5 font-sans">
              ...
              <p className="text-luxury-muted">
                Cửa hàng: Số 23/100 phố Đội Cấn, Phường Ba Đình, Thành phố Hà Nội, Việt Nam
              </p>
              <p className="text-luxury-muted">
                Điện thoại: 1900 633 428 - Fax: 7338656 - Email:{' '}
                <a href="mailto:cskh@htj.vn" className="hover:text-gold transition-colors">
                  cskh@htj.vn
                </a>
              </p>
              <p className="text-luxury-muted">
                Giấy chứng nhận đăng ký doanh nghiệp: 0101892596 do Sở Kế hoạch &amp; Đầu tư TP. Hà
                Nội cấp lần đầu ngày 02/03/2006.
              </p>
