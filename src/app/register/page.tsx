  ...
  return (
    <div className="min-h-screen bg-charcoal flex items-center justify-center px-4 py-12 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-gold/10 to-transparent animate-pulse"
      ...
      <div className="w-full max-w-md relative z-10">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  placeholder={t('register.min_chars')}
        ...
        <p className="text-center mt-6">
          <Link
            href="/homepage"
            className="text-white/70 text-xs tracking-widest uppercase hover:text-gold transition-colors duration-200"
          >
